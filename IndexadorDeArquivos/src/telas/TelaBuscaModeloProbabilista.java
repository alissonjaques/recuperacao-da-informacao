...
import controle.BuscaProbabilista;
 ...
 * @author licin
 */
public class TelaBuscaModeloProbabilista extends javax.swing.JInternalFrame {
    ...
    private void jbconsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbconsultarActionPerformed
        if (getJttextoconsulta().getText().isEmpty()) {
            ...
            try {
                ...
                busca.geraVetorDeSimilaridade(getJttextoconsulta().getText().toLowerCase());
